...
- [iOS] Capture fatal JavaScript crashes via an opt-in `RCTFatalHandler`, recording the JS message and parsed stack that MetricKit can't surface for a React Native crash. ([#46923](https://github.com/expo/expo/pull/46923) by [@tsapeta](https://github.com/tsapeta))
